...
class MonitorHandler(FileSystemEventHandler):
    ...
    def send_sns_notification(self, s3_path, event_type):
        ...
        # Create the HTML message with buttons
        message_html = f"""
        <html>
        <body>
            ...
            <p>
                <a href="{approve_link}" style="text-decoration:none;">
                    <button style="background-color: #4CAF50; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer;">Approve</button>
                </a>
                <a href="{deny_link}" style="text-decoration:none;">
                    <button style="background-color: #f44336; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer;">Deny</button>
                </a>
            </p>
        </body>
        </html>
