...
s3 = boto3.client('s3', config=boto3.session.Config(max_pool_connections=500))  # Increased pool connections significantly
...
def sync_directories(local_directory, bucket, s3_directory, max_workers=500):  # Significantly increased workers
    global total_files
    upload_tasks = []
...
if __name__ == "__main__":
    ...
    sync_directories(local_directory, bucket, s3_directory, max_workers=500)  # Significantly increased workers
